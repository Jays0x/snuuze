...
const useEmail = () => {
  ...
  const handlePhoneSubmit = () => {
    ...
    navigation.navigate('verificationEmail'); // Replace with your actual route name
  };
  ...
  return (
    <SafeAreaView className="flex h-full items-start justify-between p-5 bg-secondary">
      ...
      <View className="flex flex-col gap-2 mt-8 mb-10">
        <Text className="text-[25px] text-white tracking-tighter font-[CenturyGothic-Bold]">Input your email</Text>
        <Text className="text-white text-[14px] opacity-70 font-[CenturyGothic]">Please provide your email</Text>
      </View>
      ...
      >
        ...
        <TouchableOpacity className="w-full">
          <Link href='/sign-up' className="p-5 bg-transparent border border-[#ffffff10] w-full text-white  text-center rounded-full font-[CenturyGothic-Bold] opacity-70 text-[16px]">Use phone no. instead</Link>
        </TouchableOpacity>
